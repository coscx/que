...
class IssuesApi {
  ...
  static Future<Map<String, dynamic>> getYesterdayConnect(
      String keyWord, String page, String sex, String is_passive) async {
    ...
    try {
      Response<dynamic> rep = await dio
  ...
  static Future<Map<String, dynamic>> getStoreList(String page) async {
    ...
    try {
      Response<dynamic> rep = await dio.get('/api/v1/system/user/getTreeStores',
  ...
  static Future<Map<String, dynamic>> searchErpUser(
      String keyWord,
      String page,
      String sex,
      String mode,
      SearchParamList search,
      bool _showAge,
      int _showAgeMax,
      int _showAgeMin,
      String serveType,
  ...
  static Future<Map<String, dynamic>> editCustomer(
    ...
    try {
      Response<dynamic> rep = await dio
          .post('/api/v1/customer/editCustomer/' + uuid, queryParameters: data);
      var dd = rep.data;
      return dd;
    } on DioError catch (e) {
      return resSet(e);
  ...
  static Future<Map<String, dynamic>> getVersion(
    ...
    try {
      Response<dynamic> rep =
          await dio.post('/api/v1/auth/version', queryParameters: data);
      var dd = rep.data;
      return dd;
    } on DioError catch (e) {
      return resSet(e);
  ...
  static Future<Map<String, dynamic>> addCustomer(
    ...
    try {
      Response<dynamic> rep = await dio
          .post('/api/v1/customer/personal/addCustomer', queryParameters: data);
      var dd = rep.data;
      return dd;
    } on DioError catch (e) {
      return resSet(e);
  ...
  static Future<Map<String, dynamic>> addConnect(
    ...
    try {
      Response<dynamic> rep =
          await dio.post('/api/v1/customer/addConnect', queryParameters: data);
      var dd = rep.data;
      return dd;
    } on DioError catch (e) {
      return resSet(e);
  ...
  static Future<Map<String, dynamic>> addAppoint(
      String uuid, Map<String, dynamic> data) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    dio.options.headers['authorization'] = "Bearer " + token;
    try {
      Response<dynamic> rep = await dio.post('/api/v1/customer/addAppointment',
          queryParameters: data);
      var dd = rep.data;
      return dd;
    } on DioError catch (e) {
  ...
  static Future<Map<String, dynamic>> buyVip(
      String uuid, Map<String, dynamic> data) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    dio.options.headers['authorization'] = "Bearer " + token;
    try {
      Response<dynamic> rep =
          await dio.post('/api/v1/customer/buyVipApp', queryParameters: data);
      var dd = rep.data;
      return dd;
    } on DioError catch (e) {
      return resSet(e);
  ...
  static Future<Map<String, dynamic>> addMealFree(
      String uuid, Map<String, dynamic> data) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    dio.options.headers['authorization'] = "Bearer " + token;
    try {
      Response<dynamic> rep =
          await dio.post('/api/v1/store/addMealFree', queryParameters: data);
      var dd = rep.data;
      return dd;
    } on DioError catch (e) {
      return resSet(e);
  ...
  static Future<Map<String, dynamic>> loginWx(String code) async {
    ...
    Param['code'] = code;
    try {
      Response<dynamic> rep = await dio.post('/api/v1/auth/loginAppByWechat',
  ...
  static Future<Map<String, dynamic>> bindAppWeChat(String code) async {
    ...
    try {
      Response<dynamic> rep =
          await dio.post('/api/v1/auth/bindAppWeChat', queryParameters: Param);
      var dd = rep.data;
      return dd;
    } on DioError catch (e) {
      return resSet(e);
  ...
  static Future<Map<String, dynamic>> editCustomerOnce(
      String uuid, String type, int answer) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    dio.options.headers['authorization'] = "Bearer " + token;
    ...
    try {
      Response<dynamic> rep = await dio.post(
  ...
  static Future<Map<String, dynamic>> editCustomerDemandOnce(
  ...
  static Future<Map<String, dynamic>> editCustomerOnceString(
      String uuid, String type, String answer) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    dio.options.headers['authorization'] = "Bearer " + token;
  ...
  static Future<Map<String, dynamic>> getFlowData(
  ...
  static Future<Map<String, dynamic>> editCustomerAddress(
      String uuid, int type, Result result) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    dio.options.headers['authorization'] = "Bearer " + token;
    Map<String, dynamic> searchParam = {};
  ...
  static Future<Map<String, dynamic>> editCustomerDemandAddress(
      String uuid, int type, Result result) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    dio.options.headers['authorization'] = "Bearer " + token;
  ...
  static Future<Map<String, dynamic>> getConnectList(
  ...
  static Future<Map<String, dynamic>> getActionList(
      String uuid, String page) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    Dio dioA = Dio();
  ...
  static Future<Map<String, dynamic>> getCallList(
      String uuid, String page) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    Dio dioA = Dio();
  ...
  static Future<Map<String, dynamic>> getAppointmentList(
      String uuid, String page) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    Dio dioA = Dio();
  ...
  static Future<Map<String, dynamic>> distribute(
      String uuid, int type, String userUuid) async {
    if (type == 0) {
      type = 1;
    } else if (type == 1) {
      type = 2;
  ...
  static Future<Map<String, dynamic>> uploadPhoto(
      String type, ByteData byteData, Function fd) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    dio.options.headers['authorization'] = "Bearer " + token;
    String url = '';
    ...
    params['type'] = type;
    // 使用 dio 上传图片
    Response<dynamic> rep = await dio.post('/api/v1/customer/uploadPic',
        data: formData, queryParameters: params, onSendProgress: fd);
    var datas = (rep.data);
    return datas;
  }

  static Future<Map<String, dynamic>> uploadPhotoFile(
      String type, String path, Function fd) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    dio.options.headers['authorization'] = "Bearer " + token;
  ...
  static Future<Map<String, dynamic>> searchPhoto(
    String keyWord,
    String page,
  ) async {
    var ss = await LocalStorage.get("token");
  ...
  static Future<Map<String, dynamic>> delPhoto(
    String imgId,
  ) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    ...
    try {
      Response<dynamic> rep = await dio.post('/api/v1/customer/deleteResources',
          queryParameters: data);
      return rep.data;
    } on DioError catch (e) {
      return resSet(e);
  ...
  static Future<Map<String, dynamic>> checkUser(
      String memberId, String checked, String type, String score) async {
    var ss = await LocalStorage.get("token");
    var token = ss.toString();
    var data = {
      'uid': memberId,
    ...
    Response<dynamic> rep = await dio.post('/admin/service/photoauditflu.html',
        queryParameters: data);
    var datas = json.decode(rep.data);
  ...
  static Future<Map<String, dynamic>> getPhotoNum() async {
    ...
    var token = ss.toString();
    var data = {'token': token};
    Response<dynamic> rep = await dio.post('/admin/service/photonumflu.html',
        queryParameters: data);
    var datas = json.decode(rep.data);
  ...
  static Future<Map<String, dynamic>> getTimeLine(String memberId) async {
    ...
    Response<dynamic> rep =
        await dio.post('/admin/user/gettimeline.html', queryParameters: data);
    var datas = json.decode(rep.data);
