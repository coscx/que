...
//    "我的": Icons.account_circle,
  ...
  static Map<HighlighterStyle, String> codeThemeSupport = <HighlighterStyle, String>{
    HighlighterStyle.fromColors(HighlighterStyle.gitHub):"GitHub - Power By QueQiao Team",
    HighlighterStyle.fromColors(HighlighterStyle.darkColor):"捷特黑 - Power By QueQiao Team",
    HighlighterStyle.fromColors(HighlighterStyle.lightColor):"捷特白 - Power By QueQiao Team",
    HighlighterStyle.fromColors(HighlighterStyle.zenburn):"zenburn - Power By QueQiao Team",
