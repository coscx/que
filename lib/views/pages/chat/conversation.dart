...
import 'package:flutter_geen/views/pages/chat/view/util/permission.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';
import 'package:image_picker/image_picker.dart';
import 'package:video_player/video_player.dart';
import 'view/util/date.dart';
import 'view/util/ImMessage.dart';
...
class FlutterLcIm {
  static void sendVideoMessage(String path, {String duration}) {}

  static void sendVoiceMessage(String path, String string) {}

  static void sendImageMessage(String path) {}

  static void sendTextMessage(String text) {}

  static void createConversation(String uid, {Map<String, List<Map<String, dynamic>>> attributes}) {}

  static void queryHistoryConversationMessages(int limit, String messageId, int timestamp) {}
}
