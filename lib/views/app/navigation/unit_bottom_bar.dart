      ...
      child: Container(
        ...
        child: Container(
            ...
            child: first == 0
                ? SvgPicture.asset(
                    i == 0
                        ? "assets/packages/images/tab_home.svg"
                        : "assets/packages/images/tab_me.svg",
                ...
                : (active
                    ? Container(
                        ...
                        child: GifImage(
                          ...
                          image: Image.asset(
                            i == 0
                                ? "assets/packages/images/tab_home.webp"
                                : "assets/packages/images/tab_me.webp",
                        ...
                        : (active
                            ? Container(
                                ...
                                child: GifImage(
                                  ...
                                  image: Image.asset(
                                    i == 0
                                        ? "assets/packages/images/tab_msg.webp"
                                        : "assets/packages/images/tab_discovery.webp",
                                  ).image,
                                ),
                              )
                            : i == 0
