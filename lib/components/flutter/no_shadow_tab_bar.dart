...
class NoShadowTabBar extends StatefulWidget implements PreferredSizeWidget {
...
class _TabBarState extends State<NoShadowTabBar> {
  ...
  @override
  void didUpdateWidget(NoShadowTabBar oldWidget) {
